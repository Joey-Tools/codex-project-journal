...
- The helper clears ambient Git control variables, disables external Git configuration and lazy object fetching, and captures each raw index snapshot under monotonic time, byte, record, and stderr limits. A redirected, incomplete, malformed, changed, or over-limit snapshot fails closed.
